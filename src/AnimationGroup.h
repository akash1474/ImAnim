...
namespace ImAnim
{
    ...
    class AnimationGroup : public AbstractAnimation
    {
      public:
        ...
        /**
         * @brief Starts the animation group. Does not affect the global running animation counter.
         */
        void start();

        /**
         * @brief Stops the animation group. Does not affect the global running animation counter.
         */
        void stop();
