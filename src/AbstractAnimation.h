...
namespace ImAnim
{
    ...
    inline uint8_t totalAnimationsRunning = 0;
    inline bool AreAnimationRunning() { return totalAnimationsRunning != 0; }
    /**
    ...
    class AbstractAnimation
    {
      public:
         ...
         */
        [[nodiscard]] int getCurrentLoop() const { return m_nCurrentLoop; }

        /**
         * Retrieves the duration of this animation
         * @return this animation's duration in seconds
         */
        [[nodiscard]] virtual float getDuration() const { return m_fDurationInSecs; }
         ...
         */
        [[nodiscard]] int getLoopCount() const { return m_nLoopCount; }
