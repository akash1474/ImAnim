...
namespace ImAnim
{
    ...
    class Easing
    {
      ...
      private:
        ...
        easeInElasticHelper(double t, double b, double c, double d, double a, double p);

        /**
         * @brief Helper for calculating easing equation for a bounce easing out
         */
        [[nodiscard]] static double easeOutBounceHelper(double t, double c, double a);

        /**
         * @brief Helper for calculating easing equation for an elastic easing out
         */
        [[nodiscard]] static double
        easeOutElasticHelper(double t, double b, double c, double d, double a, double p);
    };
